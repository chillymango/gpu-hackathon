...
struct WebGPUOpaqueTensorImpl : public OpaqueTensorImpl<OpaqueHandle> {
  WebGPUOpaqueTensorImpl(
...
at::Tensor wrap_tensor(py::object &py_obj, c10::ScalarType dtype, c10::DeviceIndex device_index) {
  // Get the shape from the tensor data
  ...
  return at::detail::make_tensor<at::WebGPUOpaqueTensorImpl<std::shared_ptr<c10::SafePyObject>>>(
...
py::object unwrap_tensor(const at::Tensor &tensor) {
  ...
  auto* opaque_impl = static_cast<at::WebGPUOpaqueTensorImpl<std::shared_ptr<c10::SafePyObject>>*>(impl);
  std::shared_ptr<c10::SafePyObject> obj = opaque_impl->opaque_handle();
  return py::reinterpret_borrow<py::object>(obj->ptr(getPyInterpreter()));
}
